<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="reportePedidosCliente.aspx.vb" Inherits="cordobaPlacas.reporting" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="pnlCrystalReport" runat="server">
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="C:\Users\Manuel\Documents\GitHub\cordobaPlacas\cordobaPlacas\reportes\pedidosClientes.rpt">
            </Report>
