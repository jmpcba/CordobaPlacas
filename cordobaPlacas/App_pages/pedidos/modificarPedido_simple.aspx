...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlDetalle" runat="server">
        ...
        <p>
            <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/images/arrow_left-512.png" ToolTip="volver" Width="30px" />
        </p>
        <asp:GridView ID="grDetalle" runat="server" ToolTip="Detalle pedido" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <EditItemTemplate>
                        <asp:ImageButton ID="ImageButton2" runat="server" CommandName="update" Height="20px" ImageUrl="~/images/save.png" ToolTip="Guardar Cambios" Width="20px" />
                        ...
                        <asp:ImageButton ID="ImageButton3" runat="server" CommandName="cancel" Height="20px" ImageUrl="~/images/cancel.png" ToolTip="Cancelar Edicion" Width="20px" />
                    </EditItemTemplate>
                    <ItemTemplate>
