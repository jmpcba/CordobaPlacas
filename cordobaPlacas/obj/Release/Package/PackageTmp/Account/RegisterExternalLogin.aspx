<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="cordobaPlacas.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="cordobaPlacas" %>
